...
/**
 * Add new record file entry in db table geocontexter.gc_record_file
 *
 *  USAGE:
   <pre>

   $RecordFileAdd = $this->CoreModel('RecordFileAdd');
   ...
   $result = $RecordFileAdd->run( $params );
...
class RecordFileAdd extends    AbstractModel
                    implements InterfaceModel
{
    ...
    public function run( $params )
    {
        try {
            ...
            $params['preferred_order'] = new \Zend\Db\Sql\Expression("geocontexter.gc_get_new_entry_order('gc_record_file',
                                                                                                          'id_record',
                                                                                                          {$params['id_record']})");

            $this->insert('gc_record_file', 'geocontexter', $params);
    ...
    private function validate_params( & $params )
    {
        ...
        } else if(false === $val_digits->isValid($params['id_record'])) {
