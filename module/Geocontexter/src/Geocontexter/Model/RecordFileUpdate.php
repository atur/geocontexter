 ...
 *
   ...
   $RecordFileUpdate = $this->CoreModel('RecordFileUpdate');

   $params  = array('id_file'  => bigint,
                    'data'     => array('title'       => string,
                                        'description' => string));

   $result  = $RecordFileUpdate->run( $params );
...
class RecordFileUpdate extends    AbstractModel
                       implements InterfaceModel
{
    ...
    public function run( $params )
    {
        try {
            ...
            $this->update('gc_record_file', 'geocontexter', $params['data'], array('id_file' => $params['id_file']));
