...
/**
 * get all record images
 *
 *  USAGE:
    <pre>

    $RecordImageGetAll = $this->CoreModel('RecordImageGetAll');

    $params  = array('id_record' => bigint,
                     'id_status' => int);

    $images = $RecordImageGetAll->run( $params );
...
class RecordImageGetAll extends    AbstractModel
